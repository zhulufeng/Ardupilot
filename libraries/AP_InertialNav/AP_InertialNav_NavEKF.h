...
public:
    // Constructor
    AP_InertialNav_NavEKF(AP_AHRS_NavEKF &ahrs, AP_Baro &baro, GPS_Glitch& gps_glitch, Baro_Glitch& baro_glitch,RangeFinder &sonar) :
        AP_InertialNav(ahrs, baro, gps_glitch, baro_glitch,sonar),
        _haveabspos(false),
        _ahrs_ekf(ahrs)
        {
        }
